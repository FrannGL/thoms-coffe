...
import { API_STATICMAP_KEY } from "../firebase/googleApi";

const MapPreview = ({ latitud, longitud }) => {
	const mapPreviewUrl = `https://maps.googleapis.com/maps/api/staticmap?center=${latitud},${longitud}zoom=13&size=600x300&maptype=roadmap&markers=color:red%7Clabel:C%7C${latitud},${longitud}&key=${API_STATICMAP_KEY}`;
	const defaultMap =
